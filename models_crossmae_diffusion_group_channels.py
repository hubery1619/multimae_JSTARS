...
class CrossMaskedAutoencoderGroupChannelViT(nn.Module):
    ...
    def forward_decoder_diffusion(self, x_noise, timesteps, x_feat, x_encoder, mask, mask_partial, ids_restore, y=None):
        ...
        # x_mask_time = torch.cat((time_token, x_mask_partial_reshaped), dim=1)
        ...
        x_reconstruct_notime = x_reconstruct #x_reconstruct[:, 1:, :]
        x_decoder = self.decoder_norm(x_reconstruct_notime)
        # print("The shape of x_decoder:", x_decoder.shape)
        N_decoder, L_decoder, D_decoder = x_decoder.shape
    ...
    def forward(self, imgs, xt, t, mask_ratio=0.75, kept_mask_ratio=0.75):
...
crossmaediffusion_vit_base_patch16 = crossmaediffusion_vit_base_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
crossmaediffusion_vit_large_patch16 = crossmaediffusion_vit_large_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
crossmaediffusion_vit_huge_patch14 = crossmaediffusion_vit_huge_patch14_dec512d8b  # decoder: 512 dim, 8 blocks 