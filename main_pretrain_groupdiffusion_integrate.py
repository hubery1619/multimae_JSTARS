...
from engine_pretrain_diffusion import train_one_epoch, train_one_epoch_temporal
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model_type', default=None, choices=['group_c', 'temporal', 'vanilla', 'group_cross', 'MAE_diffusion', 'MAE_diffusion_integrate', 'group_diffusion'],
...
def main(args):
    ...
    elif args.model_type == 'group_diffusion':
        model = models_groupcrossmae_diffusion_splitself.__dict__[args.model](img_size=args.input_size,
                                                patch_size=args.patch_size,
                                                in_chans=dataset_train.in_c,
                                                norm_pix_loss=args.norm_pix_loss)
