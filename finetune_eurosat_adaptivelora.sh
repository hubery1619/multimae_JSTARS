...
python -m torch.distributed.launch --nproc_per_node=2 --use-env main_finetune_adaptivelora.py \
--wandb crossselfmae_fm_input_eurosat_finetune_adaptivelora_lastlayer_multi_lr \
...
--output_dir ./experiments/eurosatcrossselfmae_fm_input/finetune_adaptivelora_lastlayer \
--log_dir ./experiments/eurosatcrossselfmae_fm_input/finetune_adaptivelora_lastlayer \
