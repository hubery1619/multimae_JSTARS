...
torchrun --nproc_per_node=1 main_pretrain_diffusion_pixelnorm.py \
--batch_size 128 --accum_iter 4 --blr 0.0001 \
--epochs 200 --warmup_epochs 20 --num_workers 16 \
--model mae_diffusion_vit_large_patch16 \
--input_size 96 --patch_size 8 \
--mask_ratio 0.75 \
--wandb MAE_diffusion \
--model_type MAE_diffusion \
...
--output_dir ./experiments/pretrain_diffusion \
--log_dir ./experiments/pretrain_diffusion \
--norm_pix_loss