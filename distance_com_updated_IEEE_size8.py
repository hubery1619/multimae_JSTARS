...
# **调整图例位置**
ax.legend(loc='upper right', bbox_to_anchor=(0.9, 1), fontsize=8, frameon=True)  # 右上角，避免挡住曲线
# 或者放到图外：
# ax.legend(loc='upper left', bbox_to_anchor=(1, 1), fontsize=8, frameon=True)  # 放在图外

# 设置标签
ax.set_xlabel("Depth", fontsize=8)
ax.set_ylabel("Attention distance (px)", fontsize=8)
...
# 使图像更紧凑
fig.savefig('attention_distance_comparison_adjusted_legend_IEEE_size8.png', bbox_inches='tight')
# plt.show()
