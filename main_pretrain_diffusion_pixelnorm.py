...
import models_mae_diffusion_pixelnorm
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model_type', default=None, choices=['group_c', 'temporal', 'vanilla', 'group_cross', 'MAE_diffusion'],
...
def main(args):
    ...
    # non-spatial, non-temporal
        ...
        model = models_mae_diffusion_pixelnorm.__dict__[args.model](img_size=args.input_size,
                                                patch_size=args.patch_size,
                                                in_chans=dataset_train.in_c,
                                                norm_pix_loss=args.norm_pix_loss)
