...
def crossmae_vit_base_patch16_dec512d8b(**kwargs):
...
def crossmae_vit_large_patch16_dec512d8b(**kwargs):
    model = CrossMaskedAutoencoderGroupChannelViT(
        channel_embed=256, embed_dim=1024, depth=24, num_heads=16,
        decoder_channel_embed=128, decoder_embed_dim=512, decoder_depth=8, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
...
def crossmae_vit_huge_patch14_dec512d8b(**kwargs):
    model = CrossMaskedAutoencoderGroupChannelViT(
...
crossmae_vit_base_patch16 = crossmae_vit_base_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
crossmae_vit_large_patch16 = crossmae_vit_large_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
crossmae_vit_huge_patch14 = crossmae_vit_huge_patch14_dec512d8b  # decoder: 512 dim, 8 blocks
